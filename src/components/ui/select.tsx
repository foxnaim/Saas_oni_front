...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      // Brutalist — no radius, thick border
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Brutalist — no radius, thick border, hard shadow
        "rounded-none border-2 border-foreground bg-popover text-popover-foreground",
        "shadow-brutal",
        // Animations
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-xs font-bold uppercase tracking-widest text-muted-foreground",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      // Primary highlight on focus/hover
      "focus:bg-primary focus:text-black",
...
// Thick separator — brutalist divider
